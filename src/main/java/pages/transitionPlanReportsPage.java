...
public class transitionPlanReportsPage extends pagesMain {
    public transitionPlanReportsPage() throws AWTException, IOException {
    }

    String fromDate = "//*[@id='cdk-accordion-child-1']/div/div/mat-form-field[1]/div/div[1]/div[3]";
    String toDate = "//*[@id='cdk-accordion-child-1']/div/div/mat-form-field[2]/div/div[1]/div[3]";
    String retrieve = "//*[@id='cdk-accordion-child-1']/div/div/div/button";
    ...
    public void verifyTransitionPlanReportsPage() {
