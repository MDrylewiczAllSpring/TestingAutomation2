...
public class macBarraOneAPISetupTest extends TestMain {
    ...
    String configExcelName = "MACEQBARRAONEAPISETUPFILESCONFIG";
    String configExcelSheet = "MACEQBARRAONEAPISETUPFILESCONF";
    String orderBy;
    ...
    public macBarraOneAPISetupTest() throws AWTException {
    }


    @Test
    public void testMacBarraOneAPISetup() throws SQLException, IOException {
        //getConfig
