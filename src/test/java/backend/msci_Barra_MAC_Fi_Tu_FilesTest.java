...
public class msci_Barra_MAC_Fi_Tu_FilesTest extends TestMain {
    ...
    String configExcelName = "MSCI_BARRA_MAC_FI_TU_FILESCONFIG";
    String configExcelSheet = "MSCI_BARRA_MAC_FI_TU_FILESCONFI";
    String orderBy;
    String orderBy2;
    ...
    public msci_Barra_MAC_Fi_Tu_FilesTest() throws AWTException {
    }
...
//                indexName = excelConfigDataMap.get("row" + i).get("indexName").toString();
                ...
                System.out.println(rowListStaging.get(1).get("sourcefilename").toString());
                String sourceFileDate = rowListStaging.get(1).get("sourcefilename").toString();
                ...
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + sourceFileDate+ "' "+ common.orderBy + orderBy2;
                //Final
                //getFinal Doc
...
//            fileInBound = new dlInboundMap().readFile(inboundFolder, sourceFileDate+".txt");
