...
public class edmBBGRawTest extends TestMain {
    ...
    String configExcelName = "EDMBBGFILESCONFIG";
    String configExcelSheet = "EDMBBGRAW";
    String orderBy;
    ...
    public edmBBGRawTest() throws AWTException {
    }
...
//            excelConfigDataMap.get("row" + i).get("Table Name").toString();
            ...
            if (excelConfigDataMap.get("row" + i).get("RunMode").equals("TRUE")) {
                ...
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + sourceFileDateSeperated[0]+"-"+sourceFileDateSeperated[1]+"-"+minusString(1,sourceFileDateSeperated[2]) + "'";
                //Final
                //getFinal Doc
