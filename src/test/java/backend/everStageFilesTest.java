...
public class everStageFilesTest extends TestMain {
    ...
    String configExcelName = "EVERSTAGEFILESCONFIG";
    String configExcelSheet = "EVERSTAGEFILESCONFIG";
    String orderBy;
    ...
    public everStageFilesTest() throws AWTException {
    }
...
//            rowListStaging = devConnect.connectAndGetHashTable(queryStaging);
            ...
            noteCompareSplit(rowListStaging, fileInBound.toString(),2,0, headersStaging,",");
            }
