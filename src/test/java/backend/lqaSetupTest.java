...
public class lqaSetupTest extends TestMain {
    ...
    String configExcelName = "LQASETUP";
    String configExcelSheet = "LQASETUP";
    String orderBy;
    ...
    public lqaSetupTest() throws AWTException {
    }


    @Test
    public void testLQASetup() throws SQLException, IOException {
        //getConfig
