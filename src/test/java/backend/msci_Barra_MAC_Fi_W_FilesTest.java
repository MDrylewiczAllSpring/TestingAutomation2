...
public class msci_Barra_MAC_Fi_W_FilesTest extends TestMain {
    ...
    String configExcelName = "MSCI_BARRA_MAC_FI_W_FILESCONFIG";
    String configExcelSheet = "MSCI_BARRA_MAC_FI_W_FILESCONFIG";
    String orderBy;
    String orderBy2;
    ...
    public msci_Barra_MAC_Fi_W_FilesTest() throws AWTException {
    }
