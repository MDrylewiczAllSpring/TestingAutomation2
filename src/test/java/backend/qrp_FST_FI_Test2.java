...
public class FST_FI_Test2 extends TestMain {
    ...
    String configExcelName = "FI_FILESCONFIG2";
    String configExcelSheet = "FI_FILESCONFIG";
    String orderBy;
    String orderBy2;
    ...
    public FST_FI_Test2() throws AWTException {
    }
...
//                System.out.println(rowListStaging.get(1).toString());
                String sourceFileDateSeperated = rowListStaging.get(1).get("as_of_date").toString();
