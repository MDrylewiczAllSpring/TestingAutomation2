...
public class radarGridFilesTest extends TestMain {
    ...
    String configExcelName = "RADARGRIDFILESCONFIG";
    String configExcelSheet = "RADARGRIDFILESCONFIG";
    String orderBy;
    ...
    public radarGridFilesTest() throws AWTException {
    }


    @Test
    public void testRadarGridFiles() throws SQLException, IOException {
        //getConfig
