...
public class rdr_analyst_data_FilesTest extends TestMain {
    ...
    String configExcelName = "RDR_ANALYST_DATA_FILESCONFIG";
    String configExcelSheet = "RDR_ANALYST_DATA_FILESCONFIG";
    String orderBy;
    ...
    public rdr_analyst_data_FilesTest() throws AWTException {
    }
...
//                indexName = excelConfigDataMap.get("row" + i).get("indexName").toString();
                ...
                System.out.println(rowListStaging.get(1).get("sourcefiledate").toString());
                ...
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + sourceFileDateSeperated[0]+"-"+sourceFileDateSeperated[1]+"-"+sourceFileDateSeperated[2] + "' ";
                //Final
                //getFinal Doc
...
//            rowListStaging = devConnect.connectAndGetHashTable(queryStaging);
            fileInBound = new dlInboundMap().readFile(inboundFolder, sourceFileName+sourceFileDateSeperated[0]+sourceFileDateSeperated[1]+sourceFileDateSeperated[2]+".txt");
...
//            //get sql results
           ...
           noteCompareSplit(rowListStaging, fileInBound.toString(),1,0, headersStaging,"|");
            }
