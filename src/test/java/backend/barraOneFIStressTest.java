...
public class barraOneFIStressTest extends TestMain {
    ...
    String configExcelName = "BARRAONEFISTRESSTESTFILESCONFIG";
    String configExcelSheet = "BARRAONEFISTRESSTESTFILESCONFIG";
    String orderBy;
    ...
    public barraOneFIStressTest() throws AWTException {
    }


    @Test
    public void testBarraOneFIStress() throws SQLException, IOException {
        //getConfig
