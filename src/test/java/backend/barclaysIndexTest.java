...
public class barclaysIndexTest extends TestMain {
    ...
    String configExcelName = "BARCLAYSFILESCONFIG";
    String configExcelSheet = "BARCLAYS Files";
    String orderBy;
    ...
    public barclaysIndexTest() throws AWTException {
    }


    @Test
    public void testBarclaysIndex() throws SQLException, IOException {
        //getConfig
...
//            String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + prevArray[2]+"-"+prevArray[0]+"-"+prevArray[1] + "'" + common.orderBy + orderBy;
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + sourceFileDate[0] + "'";
// Final
//            //getFinal Doc
