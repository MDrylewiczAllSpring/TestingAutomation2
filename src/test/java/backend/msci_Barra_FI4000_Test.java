...
public class msci_Barra_FI4000_Test extends TestMain {
    ...
    String configExcelName = "MSCI_BARRA_FI4000_FILESCONFIG";
    String configExcelSheet = "MSCI_BARRA_FI4000_FILESCONFIG";
    String orderBy;
    String orderBy2;
    ...
    public msci_Barra_FI4000_Test() throws AWTException {
    }
...
//                indexName = excelConfigDataMap.get("row" + i).get("indexName").toString();
                ...
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + sourceFileName+ "' "+ common.and  + " " + columnName2 + " = " + "'"+ sourceFileDateSeperated[0]+"-"+sourceFileDateSeperated[1]+"-"+sourceFileDateSeperated[2]+ "' "  ;
                //Final
                //getFinal Doc
