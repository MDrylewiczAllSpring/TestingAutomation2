...
public class msciFi400MACModelTest extends TestMain {
    ...
    String configExcelName = "MSCIFI400MACMODELCONFIG";
    String configExcelSheet = "MSCIFI400MACMODEL Files";
    String orderBy;
    ...
    public msciFi400MACModelTest() throws AWTException {
    }
...
//            String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" + prevArray[2]+"-"+prevArray[0]+"-"+prevArray[1] + "'" + common.orderBy + orderBy;
                String queryFinal = common.selectAllFrom + finalParent + "." + finalParent + "." + finalTable + " " + common.where + " " + columnName1 + " = " + "'" +rowListStaging.get(1).get("SourceFileName").toString() + "'";
               // Final
//            //getFinal Doc
