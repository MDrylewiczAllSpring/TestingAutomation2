...
public class factSetIndicesConfigTest extends TestMain {
    //Huge issues, none of the indices match up properly
    ...
    String configExcelName = "FACTSETINDICESCONFIG";
    String configExcelSheet = "FACTSETINDICESCONFIG";
    String orderBy;
    ...
    public factSetIndicesConfigTest() throws AWTException {
    }


    @Test
    public void testFactSetIndicesConfig() throws SQLException, IOException {
        //getConfig
