...
public class barraOneBarraCusipXrefTest extends TestMain {
    ...
    String configExcelName = "BARRAONEBARRACUSIPXREFFILESCONFIG";
    String configExcelSheet = "BARRAONEBARRACUSIPXREF";
    String orderBy;
    ...
    public barraOneBarraCusipXrefTest() throws AWTException {
    }
