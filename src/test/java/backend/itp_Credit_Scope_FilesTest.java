...
public class itp_Credit_Scope_FilesTest extends TestMain {
    ...
    String configExcelName = "ITP_CREDIT_SCOPE_FILESCONFIG";
    String configExcelSheet = "ITP_CREDIT_SCOPE_FILESCONFIG";
    String orderBy;
    ...
    public itp_Credit_Scope_FilesTest() throws AWTException {
    }
