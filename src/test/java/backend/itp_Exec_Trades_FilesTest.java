...
public class itp_Exec_Trades_FilesTest extends TestMain {
    ...
    String configExcelName = "ITP_EXEC_TRADES_FILESCONFIG";
    String configExcelSheet = "ITP_EXEC_TRADES_FILESCONFIG";
    String orderBy;
    ...
    public itp_Exec_Trades_FilesTest() throws AWTException {
    }
