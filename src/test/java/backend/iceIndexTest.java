...
public class iceIndexTest extends TestMain {
    ...
    String configExcelName = "ICEFILESCONFIG";
    String configExcelSheet = "ICE Files";
    String orderBy;
    ...
    public iceIndexTest() throws AWTException {
    }
...
//            //get sql results
            ...
            noteCompare(rowListStaging, fileInBound.toString(), inboundStart, headersStaging);
        }
