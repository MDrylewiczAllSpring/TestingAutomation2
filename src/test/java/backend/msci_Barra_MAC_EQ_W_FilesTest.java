...
public class msci_Barra_MAC_EQ_W_FilesTest extends TestMain {
    ...
    String configExcelName = "MSCI_BARRA_MAC_EQ_W_FILESCONFIG";
    String configExcelSheet = "MSCI_BARRA_MAC_EQ_W_FILESCONFIG";
    String orderBy;
    String orderBy2;
    ...
    public msci_Barra_MAC_EQ_W_FilesTest() throws AWTException {
    }
