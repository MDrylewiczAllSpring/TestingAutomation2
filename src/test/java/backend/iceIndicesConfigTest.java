...
public class iceIndicesConfigTest extends TestMain {
    ...
    String configExcelName = "ICEINDICESFILESCONFIG";
    String configExcelSheet = "ICEINDICESFILESCONFIG";
    String orderBy;
    ...
    public iceIndicesConfigTest() throws AWTException {
    }


    @Test
    public void testIceIndicesConfig() throws SQLException, IOException {
        //getConfig
