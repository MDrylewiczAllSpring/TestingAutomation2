...
public class bBGGNetTest extends TestMain {
    ...
    String configExcelName = "BBGGNETFILESCONFIG";
    String configExcelSheet = "BBGGNETFILESCONFIG";
    String orderBy;
    ...
    public bBGGNetTest() throws AWTException {
    }


    @Test
    public void testBBGGNet() throws SQLException, IOException {
        //getConfig
...
//            System.out.println(excelStagingDataMap.toString());
                //get sql results
                List<HashMap> rowListStaging = devConnect.connectAndGetHashTableDEV(queryStaging);
                checkTableStructure(excelStagingDataMap, rowListStaging, headerStagingDocRow, stagingTable, "Table Name");
